...
# based on https://code.google.com/archive/p/ios-cmake/
...
message(STATUS "Developer root: ${CMAKE_IOS_DEVELOPER_ROOT}")
if (DEFINED CMAKE_IOS_DEVELOPER_ROOT)
    set(ENV{_CMAKE_IOS_DEVELOPER_ROOT} "${CMAKE_IOS_DEVELOPER_ROOT}")
elseif(NOT $ENV{_CMAKE_IOS_DEVELOPER_ROOT})
	set(CMAKE_IOS_DEVELOPER_ROOT "/Developer/Platforms/${IOS_PLATFORM_LOCATION}/Developer")
    set(ENV{_CMAKE_IOS_DEVELOPER_ROOT} "${CMAKE_IOS_DEVELOPER_ROOT}")
else()
    set(CMAKE_IOS_DEVELOPER_ROOT "$ENV{_CMAKE_IOS_DEVELOPER_ROOT}")
endif()
set(CMAKE_IOS_DEVELOPER_ROOT ${CMAKE_IOS_DEVELOPER_ROOT} CACHE PATH "Location of iOS Platform")

# Find and use the most recent iOS sdk
message(STATUS "SDK root: ${CMAKE_IOS_SDK_ROOT}")
if(DEFINED CMAKE_IOS_SDK_ROOT)
    set(ENV{_CMAKE_IOS_SDK_ROOT} "${CMAKE_IOS_SDK_ROOT}")
elseif(NOT $ENV{_CMAKE_IOS_SDK_ROOT})
    ...
    set(CMAKE_IOS_SDK_ROOT "$ENV{_CMAKE_IOS_SDK_ROOT}")
endif()
